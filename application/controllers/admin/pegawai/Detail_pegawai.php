...
class Detail_pegawai extends CI_Controller
{
    ...
    public function add()
    {
        ...
        $this->load->view("admin/pegawai/detail_pegawai");
    }

    public function edit($NIP = null)
    {
        if (!isset($NIP)) redirect('admin/pegawai/detail_pegawai');
        ...
        $data["admin/detail_pegawai"] = $detail_pegawai->getById($NIP);
        if (!$data["admin/detail_pegawai"]) show_404();
    ...
    public function delete($NIP=null)
    {
        ...
        if ($this->detail_pegawai_model->delete($NIP)) {
            redirect(site_url('admin/pegawai/detail_pegawai'));
        }
    }
}
